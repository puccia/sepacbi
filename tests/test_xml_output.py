...
def test_payment_basic():
    ...
    payment.add_transaction(amount=198.25, account=acct_86, creditor=beta,
                            rmtinfo='Causale 1')
    compare_xml(payment.text(), 'payment_basic.xml')
...
def test_payment_multitrans():
    ...
    compare_xml(payment.text(), 'payment_multitrans.xml')
...
def test_payment_misc_features():
    ...
    payment.add_transaction(amount=198.25, account=acct_86, creditor=beta,
                            rmtinfo='Causale 1')
    compare_xml(payment.text(), 'payment_misc_1.xml')
    ...
    compare_xml(payment.text(), 'payment_misc_2.xml')
